...
namespace JMovies.App.Migrations
{
    ...
    [Migration("20200309193252_UserManagement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JMovies.DataAccess.Entities.ResultHandling.ResultConfiguration", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ResultConfiguration");
                });

            modelBuilder.Entity("JMovies.DataAccess.Entities.ResultHandling.ResultMessage", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ResultConfigurationID")
                        .HasColumnType("bigint");

                    b.HasKey("ID");

                    b.HasIndex("ResultConfigurationID");

                    b.ToTable("ResultMessage");
                });

            modelBuilder.Entity("JMovies.Entities.UserManagement.Password", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("JMovies.Entities.UserManagement.User", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("JMovies.DataAccess.Entities.ResultHandling.ResultMessage", b =>
                {
                    b.HasOne("JMovies.DataAccess.Entities.ResultHandling.ResultConfiguration", null)
                        .WithMany("ResultMessages")
                        .HasForeignKey("ResultConfigurationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("JMovies.Entities.UserManagement.User", b =>
                {
                    b.HasOne("JMovies.Entities.UserManagement.Password", "Password")
                        .WithMany()
