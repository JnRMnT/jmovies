...
namespace JMovies
{
    ...
    // Uygulamada kullanılan uygulama kullanıcı yöneticisini yapılandırın.
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
            ...
            IOwinContext context)
        {
            ...
            // İki öğeli kimlik doğrulama sağlayıcılarını kaydedin. Bu uygulamanın kullanıcı doğrulama kodunu alma adımlarında Telefon ve E-posta kullanılır
